...
var userSchema = new mongoose_1.Schema({
    ...
    clientIds: { type: [mongoose_1.Schema.Types.ObjectId], ref: "Cuenta", default: [] },
    tenantId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Tenant", required: true },
    firstName: {
        type: String,
        trim: true,
        set: function (v) { return (v && v.trim() !== "" ? v.trim() : undefined); },
    },
    lastName: {
        type: String,
        trim: true,
    ...
    levelId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Level" },
